            ...
            <div class="modal-body">            
		        <table class="table table-hover">
                	<tbody>
                		...
                		<tr><td>내용</td><td v-html="board.content"></td></tr> <!-- CKEditor의 내용은 html tag로 구성 -->
                		<tr><td>작성자</td><td> {{board.userName}}</td></tr>
                		<tr><td>작성일시</td><td> {{ board.regDate}} {{ board.regTime }}  </td></tr>
              ...
              <div class="modal-footer" v-show="board.sameUser">
                <button type="button" @click="changeToUpdate" class="btn btn-sm btn-primary" data-bs-dismiss="modal">수정</button>
                <button type="button" @click="changeToDelete" class="btn btn-sm btn-warning">삭제</button>
              </div>
            </div>
