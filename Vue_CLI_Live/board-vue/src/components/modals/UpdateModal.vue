        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="" id="chkFileUploadUpdate" v-model="attachFile"/>
          ...
          <button @click="boardUpdate" id="btnBoardUpdate" type="button" class="btn btn-sm btn-primary float-end">수정</button>
        </div>
      </div>
    </div>
  </div>
